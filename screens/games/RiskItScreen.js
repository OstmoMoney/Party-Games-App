...
const QUESTIONS = {
  chill: {
    no: [
      ...
      "Ta to slurker",
      "Gjør din beste celebrity-imitasjon",
      "Vis det søteste bildet på telefonen din",
      "Ring mamma og si at du elsker henne",
      "Fortell om drømmereisen din",
      "Hvem her tror du tjener mest penger om 10 år",
      "Gjør 10 jumping jacks",
      "Ordet er «slange», du starter med å rime, deretter rimer alle etter hverandre fra venstre",
      "Hvem her ville du ringt kl 3 om natten om noe skjedde",
      "Gjør en freestyle rap på 15 sekunder",
      "Fortell din beste barndomsminne",
    ],
    en: [
      "Take a sip 🍺",
      ...
      "Show the sweetest photo on your phone",
      "Call your mum and tell her you love her",
      "Tell us about your dream trip",
      "Who here do you think will earn the most money in 10 years",
      "Do 10 jumping jacks",
      "The word is 'snake' — you start by rhyming it, then everyone takes turns rhyming from the left",
      "Who here would you call at 3am if something happened",
      "Do a freestyle rap for 15 seconds",
  ...
  date: {
    no: [
      ...
      "Si noe du vanligvis ikke tør å si til noen du er tiltrukket av",
      ...
      "Beskriv det søteste noen har gjort for deg",
       ...
       "Sett deg inntil daten din",
      "Det neste daten får som oppgave, må du utføre",
      "Kyss daten din",
      "Hva liker du best ved daten din, hold deg unna snill, søt, pen, morsom etc",
      "Hvor mange har du datet før din nåværende date",
      "Ta en shot",
       "Spander en shot til alle på bordet",
      "Chug resten av drinken din, deretter kyss daten din på kinnet",
      "Fortell noe mange tror om deg, men er feil",
      "Fortell dine negative sider",
      "Fortell dine positive sider",
      "Hva fikk deg til å kontakte din nåværende date",
      "Sett deg ved siden av en annen en daten din (Motsatt kjønn)",
      "Fortell dine toxic traits",
     "Fortell din date sine toxic traits",
      "Fortell om en gang du var modig i kjærlighet",
      "Si hva du ville skrevet i et kjærlighetsbrev lag scenarioet selv",
    ],
  
    en: [
      "Tell about your own toxic traits",
     "What are your partners toxic trait",
      ...
      "Whatever challenge your date gets next, you have to do it too",
      "Kiss your date",
      "What do you like most about your date, avoid words like kind, sweet, pretty, funny etc",
      "How many people have you dated before your current date",
      "Take a shot",
      "Buy a shot for everyone at the table",
      "Chug the rest of your drink, then kiss your date on the cheek",
      "Share something many people believe about you that is wrong",
      "Share your negative sides",
      "Share your positive sides",
      "What made you reach out to your current date",
      "Tell about a time you were brave in love",
      "Say what you would write in a love letter, create the scenario yourself",
      "Change seat, sit next to someone, not your date (Opposite gender)",
    ],
  },
  drunk: {
    no: [
