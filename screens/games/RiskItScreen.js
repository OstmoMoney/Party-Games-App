...
const QUESTIONS = {
  chill: [
    ...
    "Si tre ting du liker med deg selv",
    "Send en random emoji til den siste personen du snakket med",
  ],
  drunk: [
    "Ta to slurker 🍺🍺",
    ...
    "Alle sitter i stille i 30 sekunder — den som beveger seg tar en slurk",
    "Ring en venn og overbevis dem om at du er på feil fest",
    "Ta en slurk for hvert år du er over 20",
    "Gjør en 'waterfall' — alle drikker til du stopper",
    "Velg to personer som må kysse hverandre eller ta en shot",
    "Siste person til å ta hånda si i lufta tar to slurker",
  ...
  blasted: [
    ...
    "Strip ned til undertøy og gjør 5 push-ups",
    "Alle kan stille deg ETT spørsmål og du MÅ svare ærlig",
    "Ring mamma og si at du er forelsket i vennen din",
    "Ta en shot av det verste i baren",
    "Post en pinlig video på stories",
    "La noen skrive hva som helst på ryggen din med penn",
    "Gjør en lap dance for personen du velger",
    "Si din største livsangst høyt",
    "La rommet scrolle fritt i DM-ene dine",
