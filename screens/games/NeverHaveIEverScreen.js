...
const QUESTIONS = {
  chill: {
    ...
    en: [
      ...
      "I have never smelled food to check if it was still good",
      ...
      "I have never burned food at a cabin and blamed someone else",
  ...
  date: {
    no: [
      ...
      "Jeg har aldri stalkjet noen på sosiale medier",
      "Jeg har aldri løyet om å være opptatt",
      "Jeg har aldri falt for en venn",
      "Jeg har aldri angret på et brudd",
      "Jeg har aldri sendt en melding og angret med en gang",
      "Jeg har aldri kysset noen på første date",
      "Jeg har aldri later som jeg likte noe for å imponere noen",
      "Jeg har aldri hatt en hemmelig beundrer",
      "Jeg har aldri ønsket at en eks ville komme tilbake",
      "Jeg har aldri blitt forelsket i en kompis",
      ...
      "Jeg har aldri skrevet en melding om igjen mange ganger",
      "Jeg har aldri ventet spent på en melding tilbake",
      "Jeg har aldri latt som jeg ikke brydde meg når jeg egentlig gjorde det",
      "Jeg har aldri innrømmet at jeg likte noen først",
      "Jeg har aldri vært redd for å si jeg elsker deg",
      ...
      "Jeg har aldri later som jeg var over noen når jeg ikke var det",
    ],
    en: [
      "I have never texted the wrong person",
      "I have never stalked someone on social media",
      "I have never lied about being busy",
      "I have never fallen for a friend",
      "I have never regretted a breakup",
      "I have never sent a message and immediately regretted it",
      "I have never kissed someone on a first date",
      "I have never pretended to like something to impress someone",
      "I have never had a secret admirer",
      "I have never wished an ex would come back",
      "I have never fallen for a close friend",
      ...
      "I have never rewritten a message many times before sending",
      "I have never waited anxiously for a reply",
      "I have never pretended not to care when I really did",
      "I have never admitted I liked someone first",
      "I have never been scared to say I love you",
      "I have never had a crush on a coworker",
      "I have never asked for someone's number",
      "I have never sneaked out of a boring date",
      "I have never lied about what I want in a relationship",
      "I have never had feelings for two people at once",
