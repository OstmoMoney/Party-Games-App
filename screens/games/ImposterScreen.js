...
const WORDS_BY_MODE = {
  chill: {
    no: [
      ...
      { word: "Ikea", hint: "Gult" },
      { word: "McDonald's", hint: "En bokstav" },
    ...
    en: [
      ...
      { word: "Instagram", hint: "Album" },
      { word: "McDonald's", hint: "One letter" },
      ...
      { word: "Google Maps", hint: "Lost" },
      { word: "Nitendo", hint: "Mario" },
  ...
  date: {
    ...
    en: [
      ...
      { word: "Sunset walk", hint: "Romantic" },
      { word: "Lips", hint: "Mind" },
      { word: "Red roses", hint: "Meaning" },
      { word: "Stargazing", hint: "Night" },
      { word: "Picnic", hint: "Park" },
      { word: "Cooking together", hint: "Bonus points" },
      { word: "Surprise", hint: "Unexpected" },
      { word: "Love letter", hint: "Declaration" },
      { word: "Secret", hint: "Just us" },
      { word: "Mini golf", hint: "Ball" },
      { word: "Love hearts", hint: "Text" },
      { word: "Flirting", hint: "Smile" },
      { word: "First drink", hint: "Nervous" },
      { word: "Trust", hint: "Safe" },
      { word: "Missing someone", hint: "Feelings" },
      { word: "Jealousy", hint: "Green" },
      { word: "Falling in love", hint: "A lot" },
      { word: "Heartbreak", hint: "Changed" },
      { word: "Exclusive", hint: "Each other" },
      { word: "Future dreams", hint: "Together" },
      { word: "Hug", hint: "Close" },
      { word: "Promise", hint: "Words" },
      { word: "Morning coffee", hint: "Two cups" },
      { word: "Music", hint: "Connection" },
      { word: "Lazy day", hint: "Sofa" },
  ...
  drunk: {
   ...
   en: [
      ...
      { word: "Liquor store", hint: "Closes early" },
      ...
      { word: "Buying rounds", hint: "Ladies" },
      { word: "Beer pong", hint: "Red" },
      { word: "Flirting", hint: "Eye contact" },
      { word: "VIP", hint: "Worth it" },
      { word: "Karaoke bar", hint: "Microphone" },
      { word: "Open bar", hint: "Free" },
      { word: "Blood alcohol", hint: "Car keys" },
      ...
      { word: "The lads", hint: "Pints" },
      { word: "Student bar", hint: "Cheap" },
  ...
  blasted: {
    no: [
      ...
      { word: "Djengis Khan", hint: "Høvding" },
      { word: "Ted Bundy", hint: "Kald" },
      { word: "Face ID", hint: "Biometrics" },
      ...
      { word: "Svarte penger", hint: "Hvit vasking" },
